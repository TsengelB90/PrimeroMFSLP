...
var ArrowBackIos = _interopDefault(require('@mui/icons-material/ArrowBackIos'));
...
var CalenderController = function CalenderController(props) {
  ...
  return React__default.createElement("div", {
    ...
    size: 'small'
  }, React__default.createElement(ArrowBackIos, {
    fontSize: 'inherit'
  })), React__default.createElement("div", null, currentMonth, " ", currentYear), React__default.createElement(material.IconButton, {
    onClick: onNextMonth,
...
var Calender = function Calender(_ref) {
  ...
  var _useState4 = React.useState(parsedDateInitialValue),
  ...
  React.useEffect(function () {
    var parsedDateValue = parseBSDate(value || bikramSambatJs.ADToBS(new Date()));
    if (value) {
  ...
  var currentYear = numberTrans(calenderDate.bsYear);
  return React__default.createElement(React.Fragment, null, React__default.createElement(material.DialogTitle, {
    ...
    size: 'small',
    className: 'yearBtn'
  }, currentYear), React__default.createElement(material.Typography, {
    variant: 'h4'
  }, numberTrans(value || bikramSambatJs.ADToBS(new Date()))))), React__default.createElement(material.DialogContent, {
    className: 'calender'
  }, React__default.createElement("div", {
    className: 'calender-wrapper'
  }, isInitialized && (showYearPicker ? React__default.createElement(YearPicker, {
    date: calenderDate,
    onSelect: onYearSelectHandler
  }) : React__default.createElement(React.Fragment, null, React__default.createElement(CalenderController, {
  ...
  }, React__default.createElement(CalendarToday, {
    fontSize: 'inherit'
...
var NepaliDatePicker = function NepaliDatePicker(props) {
  ...
  }, componentProps))), React__default.createElement(Dialog, {
    open: showCalendar,
    onClose: function onClose() {
      return handleSetShowCalendar(false);
    },
    scroll: 'paper'
  }, React__default.createElement(Calender, {
    value: date,
